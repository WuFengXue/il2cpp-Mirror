...
#       undef STACK_GRAN
#       define STACK_GRAN 0x1000
#       define STACKBOTTOM ((ptr_t) xbox_get_stack_bottom ())
...
# error --> inconsistent configuration
#endif
#if defined(GC_WIN32_THREADS) && !defined(MSWIN32) && !defined(CYGWIN32) && !defined(_XBOX) && !defined(_XBOX_ONE) \
    && !defined(MSWINCE)
# error --> inconsistent configuration
#endif
...
#   define GET_MEM(bytes) (struct hblk *)xenon_get_mem(bytes, 0)
# elif defined(MACOS)
